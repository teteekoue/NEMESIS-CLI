...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "textual.widget","textual.css","textual.dom","textual.screen",
        "textual.widgets._header","textual.widgets._footer",
        "textual.widgets._input","textual.widgets._static",
        "textual.widgets._button","textual.widgets._switch",
        "textual.widgets._rich_log","textual.widgets._text_area",
